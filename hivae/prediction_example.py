...
print(results_path)
print(network_path)
datacsvpath = dataset_path+'/data.csv'
...
X = full_dataset_df[full_dataset_df.columns[[0,2,3,4,5,6,7,8,9]]]
Y = full_dataset_df[1].map({1:0,2:1})
...
fpr, tpr, thresholds = metrics.roc_curve(y_test, v)
