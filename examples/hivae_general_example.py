...
print(train_data)
hivae = hivae.hivae(types_list,network_dict[dataset_name],network_path,results_path)

hivae.fit(train_data,epochs=iterations[dataset_name],true_missing_mask=missing_true_train)
...
print('-'*80)
print(test_data-test_data_decoded)
print('-'*80)
print('Column-wise corrlations')
